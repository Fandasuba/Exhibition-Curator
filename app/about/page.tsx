export default function About() {
  return (
    <main className="p-8 max-w-6xl mx-auto bg-amber-50 min-h-screen">
      <h1 className="text-3xl mb-6 text-amber-800 font-bold drop-shadow-sm   ">
        About Exhibition Curator
      </h1>
     
      <div className="mb-8 p-6 bg-white/40 backdrop-blur-sm border-2 border-amber-300 rounded-lg">
        ...
        <h2 className="text-2xl font-bold text-amber-900 mb-4 border-b border-amber-400 pb-2">
          How it works
        </h2>
