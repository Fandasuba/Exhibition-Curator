...
export default function Card({
  ...
  return (
  <>
    <article aria-label="Historical artifact item" className="group perspective-1000">
      <div className="relative transform transition-all duration-300 sm:hover:scale-105">
        <div className="absolute inset-0 bg-amber-900 rounded-r-lg transform translate-x-1 sm:translate-x-4 translate-y-1 sm:translate-y-4 opacity-60 sm:opacity-80" aria-hidden="true"></div>
        <div className="absolute inset-0 bg-stone-100 rounded-r-lg transform translate-x-0.5 sm:translate-x-3 translate-y-0.5 sm:translate-y-3 opacity-70 sm:opacity-90 hidden sm:block" aria-hidden="true"></div>
        <div className="absolute inset-0 bg-stone-50 rounded-r-lg transform translate-x-0.5 sm:translate-x-2 translate-y-0.5 sm:translate-y-2 opacity-80 sm:opacity-95 hidden sm:block" aria-hidden="true"></div>
        <div className="absolute inset-0 bg-amber-50 rounded-r-lg transform translate-x-0.5 sm:translate-x-1 translate-y-0.5 sm:translate-y-1 opacity-100" aria-hidden="true"></div>
        <div className="absolute left-0 top-1 sm:top-2 bottom-1 sm:bottom-2 w-2 sm:w-3 bg-gradient-to-b from-amber-800 via-amber-900 to-amber-800 rounded-l border-r border-amber-700" aria-hidden="true"></div>
        <div className="relative bg-gradient-to-br from-amber-50 via-stone-100 to-amber-100 border border-amber-700 sm:border-2 rounded-r-lg shadow-md sm:shadow-lg overflow-hidden">
          ...
          <div className="relative p-2 sm:p-4 ml-1 sm:ml-2">
            ...
            {image && (
              <div className="relative overflow-hidden rounded mb-2 sm:mb-4 border border-amber-600 shadow-inner">
                ...
                <div className="absolute inset-0 border-2 sm:border-4 border-amber-100 pointer-events-none opacity-20 sm:opacity-30" aria-hidden="true"></div>
              </div>
            )}
            ...
            <div className="flex items-center mb-2 sm:mb-3" aria-hidden="true">
           ...
           {source && (
                ...
                aria-label="View the original source (opens in new tab)"
              >
            ...
            {showAddButton && (
              <div className="pt-2 sm:pt-3 border-t border-amber-300">
                <button
                  ...
                  disabled={!isLoggedIn}
                  aria-label={isLoggedIn ? `Add ${title} to one of your exhibitions` : `Log in to add ${title} to your exhibitions`}
                >
                  {isLoggedIn ? (
          ...
          <div className="absolute top-1 sm:top-2 right-1 sm:right-2 text-amber-600 opacity-30 sm:opacity-40 text-sm sm:text-xl" aria-hidden="true">α</div>
          <div className="absolute bottom-1 sm:bottom-2 left-3 sm:left-6 text-amber-600 opacity-30 sm:opacity-40 text-sm sm:text-xl hidden sm:block" aria-hidden="true">α</div>
          <div className="absolute bottom-0.5 sm:bottom-1 right-1 sm:right-2 text-amber-600 opacity-30 sm:opacity-40 text-xs sm:text-base" aria-hidden="true">Ω</div>
          <div className="absolute right-0 top-0 bottom-0 w-px bg-gradient-to-b from-amber-600 via-amber-500 to-amber-600 opacity-50" aria-hidden="true"></div>
        </div>
      </div>
    </article>
